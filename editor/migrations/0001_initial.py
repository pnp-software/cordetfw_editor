# Generated by Django 2.2.12 on 2021-02-23 13:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_kind', models.CharField(choices=[('STD', 'Standard Requirement'), ('CNS', 'Constraint Requirement'), ('AP', 'Adaptation Point Requirement'), ('CNS', 'Constant'), ('PAR', 'Configuration Parameter'), ('VAR', 'Global Variable'), ('PCK', 'Packet Parameter'), ('SM', 'State Machine'), ('PR', 'Procedure'), ('REP', 'Report'), ('CMD', 'Command'), ('DISC', 'Discriminant'), ('HK', 'Housekeeping Parameter'), ('PCK', 'Packet Parameter'), ('PROV', 'Service Provider'), ('USER', 'Service User'), ('TST', 'Test Case'), ('REV', 'Review Item'), ('ANA', 'Analysis Item')], max_length=24)),
